  ...
  return (
    <main className="flex min-h-[calc(100vh-3.5rem)] flex-col items-center justify-center px-6 py-12">
      <div className="max-w-2xl text-center">
        <h1 className="text-5xl font-bold tracking-tight">CropAI Knowledge Base</h1>
        <p className="mt-6 text-lg text-foreground/70 leading-relaxed">
          Compiled agronomy and reference knowledge for CropAIplus. Ingest sources,
          ask questions, and browse interlinked markdown pages.
        </p>
        <StatusBadge />
      </div>
