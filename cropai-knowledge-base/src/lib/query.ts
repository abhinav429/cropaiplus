...
const SYSTEM_PROMPT_TEMPLATE = `You are the CropAI knowledge assistant. Answer the user's question using ONLY the knowledge pages provided below.

Rules:
- Base your answer strictly on the content provided
...
const INDEX_SELECTION_PROMPT = `You are helping CropAI select relevant knowledge pages. Given a user's question and an index, return the slugs of the most relevant pages to answer the question.
